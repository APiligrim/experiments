...
export default function GraphDemo() {
  const fgRef = useRef<ForceGraphMethods<TaskNodeData, TaskLinkData>>(null);
  ...
  useEffect(() => {
    if (fgRef.current) {
      ...
      const bloomPass = new UnrealBloomPass(
        ...
        10.0, // strength - higher values = more bloom
        1.0, // radius - size of the bloom effect
        0.0 // threshold - lower values = more objects bloom
      );
  ...
  return (
    <div style={{ width: '100%', height: '100vh' }}>
      <ForceGraph<TaskNodeData, TaskLinkData>
        ref={fgRef}
        graphData={data}
        nodeRelSize={3}
